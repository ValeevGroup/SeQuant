...
if (BTAS_FOUND)
  ...
  if (${CBLAS_FOUND} AND ${LAPACKE_FOUND})
    set(BTAS_DEFINITIONS "BTAS_CBLAS_HEADER=\"${CBLAS_INCLUDE_FILE}\";BTAS_LAPACKE_HEADER=\"${LAPACKE_INCLUDE_FILE}\";BTAS_HAS_CBLAS=1;BTAS_HAS_LAPACKE=1")
    if (MKL_FOUND)
      set(BTAS_DEFINITIONS "BTAS_HAS_INTEL_MKL=1;${BTAS_DEFINITIONS}")
    endif(MKL_FOUND)
