...
See :ref:`external_interface_idx_space`. Additionally, the following properties are **required**:

* :code:`name` (String): Name of the index space
* :code:`tag` (String): Tag for this index space (if any). Tags are used to encode the spaces of a tensor's indices in its name. May be empty.
