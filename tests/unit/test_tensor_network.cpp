...
TEST_CASE("TensorNetwork", "[elements]") {
  ...
  SECTION("bliss graph") {
    ...
    if constexpr (hash_version() == hash::Impl::BoostPre181)
      REQUIRE(oss.str() ==
              L"graph g {\n"
              "v0 [label=\"{a_1}\"; color=\"#4f1,dd0\"];\n"
              "v0 -- v29\n"
              "v0 -- v58\n"
              "v1 [label=\"{a_2}\"; color=\"#4f1,dd0\"];\n"
              "v1 -- v29\n"
              "v1 -- v58\n"
              "v2 [label=\"{a_3}\"; color=\"#4f1,dd0\"];\n"
              "v2 -- v33\n"
              "v2 -- v54\n"
              "v3 [label=\"{a_4}\"; color=\"#4f1,dd0\"];\n"
              "v3 -- v33\n"
              "v3 -- v54\n"
              "v4 [label=\"{a_5}\"; color=\"#4f1,dd0\"];\n"
              "v4 -- v37\n"
              "v4 -- v50\n"
              "v5 [label=\"{a_6}\"; color=\"#4f1,dd0\"];\n"
              "v5 -- v37\n"
              "v5 -- v50\n"
              "v6 [label=\"{a_7}\"; color=\"#4f1,dd0\"];\n"
              "v6 -- v22\n"
              "v6 -- v41\n"
              "v7 [label=\"{a_8}\"; color=\"#4f1,dd0\"];\n"
              "v7 -- v22\n"
              "v7 -- v41\n"
              ...
              "v15 -- v21\n"
              "v15 -- v42\n"
              "v16 [label=\"{\\kappa_1}\"; color=\"#808,f74\"];\n"
              "v16 -- v25\n"
              "v16 -- v46\n"
              "v17 [label=\"{\\kappa_2}\"; color=\"#808,f74\"];\n"
              "v17 -- v25\n"
              "v17 -- v46\n"
              "v18 [label=\"{\\kappa_3}\"; color=\"#808,f74\"];\n"
              "v18 -- v26\n"
              "v18 -- v45\n"
              "v19 [label=\"{\\kappa_4}\"; color=\"#808,f74\"];\n"
              "v19 -- v26\n"
              "v19 -- v45\n"
