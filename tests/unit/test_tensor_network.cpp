  ...
  SECTION("bliss graph") {
    ...
    if constexpr (hash_version() == hash::Impl::BoostPre181)
      ...
      REQUIRE(oss.str() == L"graph g {\n"
              "v0 [label=\"{a_1}\"; color=\"#a78,ee8\"];\n"
              "v0 -- v29\n"
              "v0 -- v58\n"
              "v1 [label=\"{a_2}\"; color=\"#a78,ee8\"];\n"
              "v1 -- v29\n"
              "v1 -- v58\n"
              "v2 [label=\"{a_3}\"; color=\"#a78,ee8\"];\n"
              "v2 -- v33\n"
              "v2 -- v54\n"
              "v3 [label=\"{a_4}\"; color=\"#a78,ee8\"];\n"
              "v3 -- v33\n"
              "v3 -- v54\n"
              "v4 [label=\"{a_5}\"; color=\"#a78,ee8\"];\n"
              "v4 -- v37\n"
              "v4 -- v50\n"
              "v5 [label=\"{a_6}\"; color=\"#a78,ee8\"];\n"
              "v5 -- v37\n"
              "v5 -- v50\n"
              "v6 [label=\"{a_7}\"; color=\"#a78,ee8\"];\n"
              "v6 -- v22\n"
              "v6 -- v41\n"
              "v7 [label=\"{a_8}\"; color=\"#a78,ee8\"];\n"
              "v7 -- v22\n"
              "v7 -- v41\n"
              "v8 [label=\"{i_1}\"; color=\"#d3c,774\"];\n"
              "v8 -- v30\n"
              "v8 -- v57\n"
              "v9 [label=\"{i_2}\"; color=\"#d3c,774\"];\n"
              "v9 -- v30\n"
              "v9 -- v57\n"
              "v10 [label=\"{i_3}\"; color=\"#d3c,774\"];\n"
              "v10 -- v34\n"
              "v10 -- v53\n"
              "v11 [label=\"{i_4}\"; color=\"#d3c,774\"];\n"
              "v11 -- v34\n"
              "v11 -- v53\n"
              "v12 [label=\"{i_5}\"; color=\"#d3c,774\"];\n"
              "v12 -- v38\n"
              "v12 -- v49\n"
              "v13 [label=\"{i_6}\"; color=\"#d3c,774\"];\n"
              "v13 -- v38\n"
              "v13 -- v49\n"
              "v14 [label=\"{i_7}\"; color=\"#d3c,774\"];\n"
              "v14 -- v21\n"
              "v14 -- v42\n"
              "v15 [label=\"{i_8}\"; color=\"#d3c,774\"];\n"
              "v15 -- v21\n"
              "v15 -- v42\n"
              "v16 [label=\"{\\kappa_1}\"; color=\"#7a0,7dc\"];\n"
              "v16 -- v25\n"
              "v16 -- v46\n"
              "v17 [label=\"{\\kappa_2}\"; color=\"#7a0,7dc\"];\n"
              "v17 -- v25\n"
              "v17 -- v46\n"
              "v18 [label=\"{\\kappa_3}\"; color=\"#7a0,7dc\"];\n"
              "v18 -- v26\n"
              "v18 -- v45\n"
              "v19 [label=\"{\\kappa_4}\"; color=\"#7a0,7dc\"];\n"
              "v19 -- v26\n"
              "v19 -- v45\n"
        ...
        for (auto N :
          ...
          auto ctx_resetter = set_scoped_default_context(
              (N > Index::min_tmp_index())
                  ? sequant::Context(get_default_context())
