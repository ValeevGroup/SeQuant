...
TEST_CASE("Spin") {
  ...
  SECTION("Tensor") {
    ...
    REQUIRE(to_latex(result) ==
            L"{ \\left( - {{{2}}{g^{{p_4}{p_3}}_{{p_1}{p_2}}}} + {{{2}}{g^{{p_3}{p_4}}_{"
            L"{p_1}{p_2}}}}\\right) }");
  }
  ...
  SECTION("Scaled Product") {
    {
      ...
      REQUIRE(result->size() == 2);
      REQUIRE(to_latex(result) ==
              L"{ \\left({{{2}}{g^{{a_1}{a_2}}_{{i_1}{i_2}}}{t^{{i_1}}_{{a_1}}}{t^{{i_2}}_{"
          L"{a_2}}}} - {{g^{{a_1}{a_2}}_{{i_1}{i_2}}}{t^{{i_2}}_{{a_1}}}{t^{{i_1}}_{{a_2}"
          L"}}}\\right) }");
    }
  }
  ...
  SECTION("Sum") {
    ...
    REQUIRE(
        ...
        L"{a_1}}_{{i_1}}}{t^{{i_1}}_{{a_1}}}} + {{{2}}{g^{{a_1}{a_2}}_{{i_1}{i_2}}}{t^{"
        L"{i_1}}_{{a_1}}}{t^{{i_2}}_{{a_2}}}} - {{g^{{a_1}{a_2}}_{{i_1}{i_2}}}{t^{{i_2}"
        L"}_{{a_1}}}{t^{{i_1}}_{{a_2}}}}\\right) }");
  }  // Sum
