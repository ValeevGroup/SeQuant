...
SECTION("Closed-shell CC spintrace for variable, constant, product") {
  ...
  SECTION("Closed-shell spintrace CCSDT terms") {
    {  // A3 * f * t3, , spintracing with partial-expansion
      ...
      REQUIRE_THAT(
          result,
          EquivalentTo(
              "2 S{i1,i2,i3;a1,a2,a3} f{i4;i3} t{a1,a2,a3;i4,i1,i2} - 4 "
  ...
  SECTION("Relation in spin P operators") {
    ...
    auto P13_b =
        ex<Tensor>(L"P", bra{}, ket{L"a_1", L"a_3"}, Symmetry::Nonsymm);
    auto P13_k =
        ex<Tensor>(L"P", bra{L"i_1", L"i_3"}, ket{}, Symmetry::Nonsymm);
    auto P12_b =
        ex<Tensor>(L"P", bra{}, ket{L"a_1", L"a_2"}, Symmetry::Nonsymm);
    auto P12_k =
        ex<Tensor>(L"P", bra{L"i_1", L"i_2"}, ket{}, Symmetry::Nonsymm);

    auto P23_b =
        ex<Tensor>(L"P", bra{}, ket{L"a_2", L"a_3"}, Symmetry::Nonsymm);
    auto P23_k =
        ex<Tensor>(L"P", bra{L"i_2", L"i_3"}, ket{}, Symmetry::Nonsymm);
  ...
  SECTION("Open-shell spin-tracing") {
    ...
    {
      auto t3 =
          ex<Tensor>(Tensor(L"t", bra{a3A, a2B, a2A}, ket{i1A, i2B, i3A}));
    ...
    // f_oo * t2
    {
      ...
      REQUIRE_THAT(result[1],
                   EquivalentTo("-1/2 f{i↑2;i↑1} t{a↑1,a↓2;i↑2,i↓2}"));
    ...
    // aab: g*t3 (CCSDT R3 4)
    {
      ...
      REQUIRE_THAT(
          result, EquivalentTo(
                      "1/3 g{i↑3,i↑4;i↑1,i↑2}:A t{a↑1,a↑2,a↓3;i↑3,i↑4,i↓3}:N"));
      ...
      REQUIRE_THAT(
          result,
          EquivalentTo(
              "1/3 g{i↑3,i↑4;i↑1,i↑2}:A t{a↑_1,a↑2,a↓3;i↑3,i↑4,i↓3}:N"));
    }
