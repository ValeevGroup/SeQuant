...
//        std::wcout << "result: " << to_latex(result) << "\n\n";
  ...
  SECTION("Open-shell permutation"){
      // Permutation operator used to replace A operator before spin-tracing
      auto expr1 = open_shell_P_operator(2,3);
      auto expr2 = open_shell_P_operator(1,3);
      auto expr3 = open_shell_P_operator(3,4);
      auto expr4 = open_shell_P_operator(1,4);
      REQUIRE(expr1->size() == 9);
      REQUIRE(expr2->size() == 9);
      REQUIRE(expr3->size() == 16);
      REQUIRE(expr4->size() == 16);
      REQUIRE(to_latex(expr1) ==
      L"{ \\bigl({{{1}}} - {{P^{{a_{98}}{a_{99}}}_{{i_1}{i_3}}}} - "
      L"{{P^{{a_{98}}{a_{99}}}_{{i_2}{i_3}}}} - "
      L"{{P^{{a_1}{a_3}}_{{i_{98}}{i_{99}}}}} - "
      L"{{P^{{a_2}{a_3}}_{{i_{98}}{i_{99}}}}} + "
      L"{P^{{a_1}{a_3}}_{{i_1}{i_3}}} + {P^{{a_2}{a_3}}_{{i_1}{i_3}}} "
      L"+ {P^{{a_1}{a_3}}_{{i_2}{i_3}}} + "
      L"{P^{{a_2}{a_3}}_{{i_2}{i_3}}}\\bigr) }");
      REQUIRE( to_latex(expr2) ==
      L"{ \\bigl({{{1}}} - {{P^{{a_{98}}{a_{99}}}_{{i_1}{i_2}}}} - "
      L"{{P^{{a_{98}}{a_{99}}}_{{i_1}{i_3}}}} - "
      L"{{P^{{a_1}{a_2}}_{{i_{98}}{i_{99}}}}} - "
      L"{{P^{{a_1}{a_3}}_{{i_{98}}{i_{99}}}}} + "
      L"{P^{{a_1}{a_2}}_{{i_1}{i_2}}} + {P^{{a_1}{a_3}}_{{i_1}{i_2}}} + "
      L"{P^{{a_1}{a_2}}_{{i_1}{i_3}}} + "
      L"{P^{{a_1}{a_3}}_{{i_1}{i_3}}}\\bigr) }");
      REQUIRE( to_latex(expr3) ==
      L"{ \\bigl({{{1}}} - {{P^{{a_{98}}{a_{99}}}_{{i_1}{i_4}}}} - "
      L"{{P^{{a_{98}}{a_{99}}}_{{i_2}{i_4}}}} - "
      L"{{P^{{a_{98}}{a_{99}}}_{{i_3}{i_4}}}} - "
      L"{{P^{{a_1}{a_4}}_{{i_{98}}{i_{99}}}}} - "
      L"{{P^{{a_2}{a_4}}_{{i_{98}}{i_{99}}}}} - "
      L"{{P^{{a_3}{a_4}}_{{i_{98}}{i_{99}}}}} + "
      L"{P^{{a_1}{a_4}}_{{i_1}{i_4}}} + {P^{{a_2}{a_4}}_{{i_1}{i_4}}} + "
      L"{P^{{a_3}{a_4}}_{{i_1}{i_4}}} + {P^{{a_1}{a_4}}_{{i_2}{i_4}}} + "
      L"{P^{{a_2}{a_4}}_{{i_2}{i_4}}} + {P^{{a_3}{a_4}}_{{i_2}{i_4}}} + "
      L"{P^{{a_1}{a_4}}_{{i_3}{i_4}}} + {P^{{a_2}{a_4}}_{{i_3}{i_4}}} + "
      L"{P^{{a_3}{a_4}}_{{i_3}{i_4}}}\\bigr) }");
      REQUIRE( to_latex(expr4) ==
      L"{ \\bigl({{{1}}} - {{P^{{a_{98}}{a_{99}}}_{{i_1}{i_2}}}} - "
      L"{{P^{{a_{98}}{a_{99}}}_{{i_1}{i_3}}}} - "
      L"{{P^{{a_{98}}{a_{99}}}_{{i_1}{i_4}}}} - "
      L"{{P^{{a_1}{a_2}}_{{i_{98}}{i_{99}}}}} - "
      L"{{P^{{a_1}{a_3}}_{{i_{98}}{i_{99}}}}} - "
      L"{{P^{{a_1}{a_4}}_{{i_{98}}{i_{99}}}}} + "
      L"{P^{{a_1}{a_2}}_{{i_1}{i_2}}} + {P^{{a_1}{a_3}}_{{i_1}{i_2}}} + "
      L"{P^{{a_1}{a_4}}_{{i_1}{i_2}}} + {P^{{a_1}{a_2}}_{{i_1}{i_3}}} + "
      L"{P^{{a_1}{a_3}}_{{i_1}{i_3}}} + {P^{{a_1}{a_4}}_{{i_1}{i_3}}} + "
      L"{P^{{a_1}{a_2}}_{{i_1}{i_4}}} + {P^{{a_1}{a_3}}_{{i_1}{i_4}}} + "
