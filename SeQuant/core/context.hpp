...
class Context {
 public:
  struct Defaults {
    ...
    constexpr static auto strict_braket_symmetry = StrictBraKetSymmetry::Yes;
  ...
  struct Options {
      ...
      /// the StrictBraKetSymmetry object
      StrictBraKetSymmetry strict_braket_symmetry = Defaults::strict_braket_symmetry;
      /// the SPBasis object
  ...
  /// \return StrictBraKetSymmetry of this context
  StrictBraKetSymmetry strict_braket_symmetry() const;
  ...
  /// Sets the StrictBraKetSymmetry for this context, convenient for chaining
  /// \param strict_braket_symmetry StrictBraKetSymmetry
  /// \return ref to `*this`, for chaining
  Context& set(StrictBraKetSymmetry strict_braket_symmetry);
 ...
 private:
  ...
  StrictBraKetSymmetry strict_braket_symmetry_ = Defaults::strict_braket_symmetry;
