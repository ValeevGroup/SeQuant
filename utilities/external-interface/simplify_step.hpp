#ifndef SEQUANT_EXTERNAL_INTERFACE_SIMPLIFYSTEP_HPP
#define SEQUANT_EXTERNAL_INTERFACE_SIMPLIFYSTEP_HPP
...
class SimplifyStep : public OneByOneProcessingStep<ExpressionData> {
 public:
...
#endif  // SEQUANT_EXTERNAL_INTERFACE_SIMPLIFYSTEP_HPP
