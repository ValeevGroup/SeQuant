#ifndef SEQUANT_EXTERNAL_INTERFACE_PROJECTIONSTEP_HPP
#define SEQUANT_EXTERNAL_INTERFACE_PROJECTIONSTEP_HPP
...
class ProjectionStep : public OneByOneProcessingStep<ExpressionData> {
 public:
...
#endif  // SEQUANT_EXTERNAL_INTERFACE_PROJECTIONSTEP_HPP
