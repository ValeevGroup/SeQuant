...
#ifndef SEQUANT2_SRCC_HPP
#define SEQUANT2_SRCC_HPP
...
using sequant2::mbpt::sr::so::H;
using sequant2::mbpt::sr::so::H1;
using sequant2::mbpt::sr::so::H2;
using sequant2::mbpt::sr::so::H0mp;
using sequant2::mbpt::sr::so::H1mp;
using sequant2::mbpt::sr::so::vac_av;
